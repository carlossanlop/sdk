...
public static class Program
{
    ...
    private static void HandleCommand(DiffConfiguration diffConfig)
    {
        ...
        LogDiagnosticsAndWarnings("before", beforeLoader);
        LogDiagnosticsAndWarnings("after", afterLoader);
    }
    ...
    private static void LogDiagnosticsAndWarnings(string stageName, IAssemblySymbolLoader loader)
    {
        loader.LogAllDiagnostics($"Found Roslyn diagnostics in {stageName} analysis:");
        loader.LogAllWarnings($"Found Roslyn warnings in {stageName} analysis:");
    }
}
