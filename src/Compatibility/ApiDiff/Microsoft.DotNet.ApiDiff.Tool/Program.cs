...
public static class Program
{
    ...
    private static void HandleCommand(DiffConfiguration diffConfig)
    {
        ...
        DiffGenerator generator = new(logger,
                                      ...
                                      SymbolFilterFactory.GetFilterFromList(diffConfig.AttributesToExclude),
                                      header: string.Empty,
    ...
    private static (IAssemblySymbolLoader, Dictionary<string, IAssemblySymbol>) GetLoaderAndSymbols(ILog logger, string assembliesFolderPath, string? refAssembliesFolderPath, Dictionary<string, ReportDiagnostic>? diagnosticOptions)
    {
