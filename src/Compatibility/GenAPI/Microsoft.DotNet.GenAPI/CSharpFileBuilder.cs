...
namespace Microsoft.DotNet.GenAPI
{
    ...
    public sealed class CSharpFileBuilder : IAssemblySymbolWriter
    {
                                 ...
                                 IEnumerable<MetadataReference>? metadataReferences = null)
        {
            ...
            _header = header;
            _docGenerator = new CSharpAssemblyDocumentGenerator(log, loader, symbolFilter, attributeDataSymbolFilter, exceptionMessage, includeAssemblyAttributes, metadataReferences);
        }
